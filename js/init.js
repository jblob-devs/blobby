...
let quest={
    ...
    UnlockSlimyWoods: new Quest("Unlock Slimy Woods", "Venture the Slimy Woods",false,"Clear wave 10 in the sun plains", new reward('locationStats.SlimyWoods.unlocked',true)),
}